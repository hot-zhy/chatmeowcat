...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.t($options.noNetwork),
    d: common_vendor.t($options.toSet),
    e: common_vendor.o((...args) => $options.openSettings && $options.openSettings(...args))
  } : {
    f: common_vendor.t($options.error),
    g: common_vendor.t(JSON.stringify($props.state.error))
  }) : {
    h: common_vendor.p({
      status: $props.state.loading ? "loading" : $props.state.hasMore ? "hasMore" : "noMore"
    })
  }, {
    i: common_vendor.o((...args) => $options.appear && $options.appear(...args))
  });
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-740c4771"], ["__file", "E:/projects/chatcat/components/uni-load-state/uni-load-state.vue"]]);
