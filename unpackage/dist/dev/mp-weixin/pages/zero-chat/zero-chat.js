...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.f(_ctx.msgList, (msg, index, i0) => {
      return {
        a: common_vendor.sr("msg", "21172fd6-0-" + i0, {
          "f": 1
        }),
        b: index,
    ...
    E: _ctx.popupHeight,
    F: common_vendor.sr("history", "21172fd6-4"),
    G: common_vendor.p({
      type: "left",
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/projects/chatcat/pages/zero-chat/zero-chat.vue"]]);
