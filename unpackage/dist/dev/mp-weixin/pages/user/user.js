...
const userServiceAgreement = `
		感谢您对我们平台的信任，通过我们平台寻求心理支持和心理建议。我们平台是华东师范大学应用心理专业硕士的实践服务平台，向签约的服务群体提供心理疏导和支持服务，以及相关的科普教育，本平台不是常规的心理咨询服务和危机干预的热线，更不是心理治疗服务平台，如果您有心理治疗和咨询服务的需求，请联系具有行业资质的心理咨询与治疗机构。
		
		为明晰您的各自的权利与责任，在开启聊天模式前，请您认真说读以下内容:
		...
		五、保密例外
		1.对于存在精神疾病倾向、缺乏自知能力的，或者有可能对自身或他人的生命安全构成严重危害的当事人，平台有权利联系相关负责机构或人员，采取相应的保护措施，尊重生命第一原则。
		2.司法机构强制要求配合。
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.t($data.userServiceAgreementTitle),
    b: common_vendor.t($data.userServiceAgreement)
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/projects/chatcat/pages/user/user.vue"]]);
