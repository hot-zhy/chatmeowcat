...
const _sfc_main = {
  ...
  onShow() {
    this.hasLogin = common_vendor.Ds.getCurrentUserInfo().tokenExpired > Date.now();
  },
  onLoad() {
    let gridList = [];
    for (var i = 0; i < 3; i++) {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: common_vendor.sr("bannerdb", "1013f2da-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/projects/chatcat/pages/grid/grid.vue"]]);
